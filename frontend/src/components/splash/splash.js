        ...
        <div className="ui masthead center
         aligned segment"style={{ background: '#00000000', border: 'none', boxShadow: 'none' }}>
            <div className="ui text" style={{ background: '000000' }}>
                ...
                <Link to={'/signup'}>
                    <div id="splash-get-started" className="ui button massive pink" style={{ transition: "all 0.3s ease 0s", borderRadius: "10px"}}>
                        Get Started
                    </div>
                </Link>
            </div>
            ...
            <div className="splash-img ui fluid image" style={{ background: '#000000', boxShadow: 'none' }}>
                <img src={image} className="image" alt="splash" style={{ position: 'fixed', zIndex: '-1000', top: '0', left: '0', filter: 'grayscale(30%) blur(0px)', minHeight: '100vh', minWidth: '100vw', objectFit: 'cover' }} />
            </div>
        </div>
